...
class GameInitializer(enginev2):
    def __init__(self, playernum):
        super().__init__(playernum)
        self.colors = {1: 'RED', 2: 'YELLOW', 3: 'GREEN', 4: 'BLUE', 5: 'BLACK'}
        self.skill = {11: '_SKILL_0', 12: '_SKILL_1', 13: '_SKILL_2', 14: '_SKILL_3', 15: '_SKILL_4'}
        self.renderer = GameRenderer(playernum)
...
class GameEngine(enginev2):
    def __init__(self, playernum):
        super().__init__(playernum)
        self.initializer = GameInitializer(playernum)
        self.state_manager = GameStateManager(playernum)
        self.renderer = GameRenderer(playernum)

    def startGame(self):
        self.initializer.set_deck()
        self.initializer.distribute_cards()
        self.initializer.create_deck()
        self.initializer.create_player_groups()
        self.initializer.set_window()
